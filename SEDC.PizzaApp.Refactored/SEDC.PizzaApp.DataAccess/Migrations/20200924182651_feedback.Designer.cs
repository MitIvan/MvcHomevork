...
namespace SEDC.PizzaApp.DataAccess.Migrations
{
    ...
    [Migration("20200924182651_feedback")]
            ...
            modelBuilder.Entity("SEDC.PizzaApp.Domain.Models.Feedback", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Email = "test@test.com", Message = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed erat magna", Name = "Ivan" },
                        new { Id = 2, Email = "test@test4.com", Message = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed erat magna", Name = "Ivan" }
                    );
                });
