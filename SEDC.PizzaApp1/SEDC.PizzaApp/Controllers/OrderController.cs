...
namespace SEDC.PizzaApp.Controllers
{
    public class OrderController : Controller
    {
        ...
        public IActionResult CreateOrderPost(OrderViewModel orderViewModel)
        {
            ...
            // Ovde se iznamaciv ne znaev zasto vrakja broj kako strin a ne ime na pizza
        ...
        public IActionResult EditOrderPost(OrderViewModel orderViewModel)
        {
            ...
            if (order == null)
                return View("ResourceNotFound");
            //I tuka isto taka
            Pizza pizza = StaticDb.Pizzas.FirstOrDefault(x => x.Id.ToString().Equals(orderViewModel.PizzaName));
            //validation for user - to do
            if (pizza == null)
                return View("BadRequest");
